#############################################################################
# Makefile for building: SmartLib
# Generated by qmake (3.1) (Qt 6.8.1)
# Project:  SmartLib.pro
# Template: app
# Command: C:\Qt\6.8.1\mingw_64\bin\qmake.exe -o Makefile SmartLib.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: SmartLib.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile SmartLib.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
